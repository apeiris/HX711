...
void setup() {
  ...
  calibrationValue = -900.570; // uncomment this if you want to set the calibration value in the sketch
...
void loop() {
  ...
  const int serialPrintInterval = 1250; //increase value to slow down serial print activity
 

  if (LoadCell.update()) newDataReady = true;
 
  // get smoothed value from the dataset:t
  if (newDataReady) {
